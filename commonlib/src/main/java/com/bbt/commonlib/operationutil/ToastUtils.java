...
/**
  *  @author lixiaonan
  *  功能描述: toast工具类显示的 这个类考虑兼容性 需要测试各种UI下是否展示正常
  *  时 间： 2019-11-08 20:06
  */
public final class ToastUtils {
     ...
     * @param text The text.
     */
    public static void showShortNormal(final CharSequence text) {
     ...
     * @param text The text.
     */
    public static void showLongNormal(final CharSequence text) {
        if (StringUtil.isNotEmpty(text)) {
